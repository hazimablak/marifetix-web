  ...
  const teamMembers = [
    {
      id: 1,
      name: "Hazım Ablak",
      slug: "hazim-ablak", // 🔥 Link için eklendi
      role: "Kurucu & Yazılım Geliştirici",
      image: "/hazim.png", // Daha önce eklediğimiz fotoğraf
    ...
    <section id="team" className="w-full py-24 bg-gray-50 border-t border-gray-100">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-brandDark mb-4">Geliştirici Ekibimiz</h2>
          <p className="text-gray-500 max-w-2xl text-lg">Bu projelerin ve kusursuz sistemlerin arkasındaki beyin takımı.</p>
        </div>
              ...
              <div className="px-6 pb-8 relative text-center">
                ...
                <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                  <div className="flex space-x-3 text-gray-400">
                    <a href="https://github.com/hazimablak" target="_blank" rel="noopener noreferrer" className="hover:text-brandOrange transition">
                  ...
                  {/* 🔥 Gerçek sayfa linkine yönlendirildi */}
                  <Link href={`/team/${member.slug}`} className="text-brandOrange text-sm font-semibold flex items-center hover:text-orange-600 transition">
