  ...
  return (
    <section className="w-full py-24 bg-white border-t border-gray-100">
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="bg-brandLight p-12 md:p-16 rounded-[3rem] shadow-sm border border-gray-100 text-center relative overflow-hidden">
          
          {/* Arka plan ince deseni */}
          <div className="absolute inset-0 z-0 opacity-30" style={{ backgroundImage: 'radial-gradient(#ff6b35 1px, transparent 1px)', backgroundSize: '40px 40px' }}></div>
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-brandDark mb-6">
            ...
            <Link 
              href="/contact" 
              className="px-10 py-4 bg-brandOrange text-white font-bold text-lg rounded-xl shadow-lg hover:bg-orange-600 transition duration-300 inline-flex items-center gap-3 group"
            >
